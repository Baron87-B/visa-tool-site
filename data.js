window.VISA_DATA = {
  ...
  iterations: [
    ...
    },
    {
      ...
      date: "2026-07-22",
      title: "流程型信息架构",
      detail: "将工作台从功能并列标签重构为总览、计划、材料、填写、复核与导出五个办理阶段；资料清单与资料夹合并为材料阶段，表格与行程合并为填写阶段，为后续日历节点导出打下结构基础。"
    },
    {
      version: "0.6.0",
      date: "2026-07-15",
    ...
    },
    {
      ...
      date: "2026-07-15",
      title: "目的地切换不自动建案",
      detail: "修复点击没有现成案件的目的地时自动创建案件的问题。现在目的地切换只进入未保存草稿；如果该目的地已有案件才自动切换到对应案件，新增案件必须由用户点击“新建”明确创建。"
    },
    {
      version: "0.5.8",
      date: "2026-07-15",
      title: "资料清单与资料夹联动",
      detail: "资料夹计划新增资料 ID 对应关系，清单可跳到资料夹位置，资料夹也可回到清单项；选择本机案件资料夹扫描后，检测到文件会自动标记为“已检测到文件”，但仍需用户复核内容真实性后手动确认完成。"
    },
    {
      version: "0.5.7",
      date: "2026-07-15",
    ...
    },
    {
      ...
      date: "2026-07-15",
      title: "目的地、案件与行程状态同步",
      detail: "修复选择目的地后我的案件仍停留在其他国家、行程草稿复用旧目的地的问题。行程缓存改为按目的地隔离。"
    },
    {
      version: "0.5.5",
      date: "2026-07-15",
